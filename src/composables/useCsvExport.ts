 ...
 */
function generateBatchRunFilename(batchRunId?: string, testCaseName?: string): string {
...
export interface CsvExportComposable {
  ...
  escapeCsvField: (value: string | number | boolean | null | undefined) => string;
}
...
export function useCsvExport(): CsvExportComposable {
  ...
  const exportBatchResults = (
    ...
    const filename = options.filename || generateBatchRunFilename(
      options.batchRunId, 
