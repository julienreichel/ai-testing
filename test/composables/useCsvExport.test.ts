...
describe("useCsvExport - CSV Export Functionality", () => {
  ...
  describe("convertResultsToCsv", () => {
    it("should convert batch results to properly formatted CSV", () => {
      ...
      // Check header
      expect(csv).toContain("Run,Status,Duration (ms),Cost ($),Passed,Prompt Tokens,Completion Tokens,Total Tokens,Retry Count,Response");
      ...
      expect(csv).toContain("1,completed,1500,0.001234,true,10,20,30,0,Simple response");
    ...
    it("should handle empty results array", () => {
      ...
      expect(lines[0]).toBe("Run,Status,Duration (ms),Cost ($),Passed,Prompt Tokens,Completion Tokens,Total Tokens,Retry Count,Response");
    });
